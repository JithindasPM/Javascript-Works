...
function displayCountry(counrty) {
    ...
    for (let c of counrty) {

        htmlData += `
        
        <div class="w-[300px] rounded-md border bg-light crd">
        <img
        src="${c.flag}"
        alt="Laptop"
        ...
        <h3 class="mt-3 text-md font-semibold">
        Capital : ${c.capital}</h3>
        <button
        type="button"
...
function generateSelectBoxs(){
    ...
    let selctBox=document.querySelector("#selectBox")

    for (let cu of choice){
...
function displayDetailCountry(items){
