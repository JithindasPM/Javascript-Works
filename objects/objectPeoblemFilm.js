...
// movies has runtime below 140

// var moviesRuntimeFilter=films.filter(f=>f.runtime<140).map(f=>f.title)
// console.log(moviesRuntimeFilter);

// movie with heighest runtime 

// var movieHightRuntime=films.reduce((f1,f2)=>Number(f1.runtime)<Number(f2.runtime) ? f2:f1);
// console.log(movieHightRuntime.title);


// move with lowest runtime 


// var movieLowestRuntime=films.reduce((f1,f2)=>Number(f1.runtime)<Number(f2.runtime) ? f1:f2);
// console.log(movieLowestRuntime.title);


// action movies names 

// var actionMovies=films.filter(f=>f.genres.includes('Action')).map(f=>f.title)
// console.log(actionMovies);

// var movieDramaAction=films.filter(f=>f.genres.includes("Action") || f.genres.includes("Drama")).map(f=>f.title);
// console.log(movieDramaAction);

// yearwise movie count and most number of movie year
...
// console.log(years);
// var nesstedArray=Object.entries(years);
// var mostRelesedMovieYear=nesstedArray.reduce((f1,f2)=>f1[1]<f2[1] ? f2 : f1)
// console.log(mostRelesedMovieYear);